...
class InformacionInspectorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inicialesProvider = Provider.of<InicialesProvider>(context, listen: false);

    return FutureBuilder(
        future: inicialesProvider
            .cargarDatosInspector(), // Llamada para cargar los datos del inspector
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            ...
            return const Center(child: Text('Error al cargar datos del inspector'));
          }
          return Container(
