...
class FormatoGeneralScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Formato General | inspección: '),
      ),
      body: Container(
        color: Colors.white,
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    decoration:
                        const InputDecoration(labelText: 'Nombre del inmueble'),
                    initialValue: tipo == 'editar'
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      formFormatoGeneral.muros_madera_lamina_otros_2 = value;
                    },
                  ),
                  const SizedBox(height: 16),
                  const Text(
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      formFormatoGeneral.asimetria_muro_cubos_cargas = value;
                    },
                  ),
                  SwitchListTile(
                    title: const Text('Grandes aberturas, entrantes/salientes'),
                    value: tipo == 'editar'
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      formFormatoGeneral.muros_no_llegan_cimentacion = value;
                    },
                  ),
                  SwitchListTile(
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      if (tipo == 'editar') {
                        formatoGeneral.grandes_masas_pisos_superiores = value;
                      }
                      formFormatoGeneral.grandes_masas_pisos_superiores = value;
                    },
                  ),
                  SwitchListTile(
                    title: const Text('Reducción brusca de pisos superiores'),
                    value: tipo == 'editar'
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.separacion_edif_vecino.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.inclinacion_edificio.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    decoration:
                        const InputDecoration(labelText: 'Grietas max (mm) '),
                    initialValue: tipo == 'editar'
                    ...
                    onChanged: (value) {
                      ...
                      formFormatoGeneral.grietas_max = double.parse(value);
                    },
                  ),
                  TextFormField(
                    decoration:
                        const InputDecoration(labelText: 'Flechas max (cm)  '),
                    initialValue: tipo == 'editar'
                    ...
                    onChanged: (value) {
                      ...
                      formFormatoGeneral.flechas_max = double.parse(value);
                    },
                  ),
                  const SizedBox(height: 16),
                  const Text(
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.col_ancho_max_grieta.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.col_separacion_estribos.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.trabes_ancho_max_grieta.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    decoration: const InputDecoration(
                        labelText: 'Separación de estribos (cm) '),
                    initialValue: tipo == 'editar'
                        ? formatoGeneral.trabes_separacion_estribos.toString()
                  ...
                  TextFormField(
                    decoration: const InputDecoration(
                        labelText: 'Sección o espesor de muro (cm) '),
                    initialValue: tipo == 'editar'
                        ? formatoGeneral.trabes_seccion_espesor_muro.toString()
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.mc_separacion_estribos.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.mc_seccion_espesor_muro.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.mm_separacion_estribos.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ...
                        : formFormatoGeneral.mm_seccion_espesor_muro.toString(),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      return (value != null && value != '')
                          ? null
                  ...
                  TextFormField(
                    ...
                    initialValue: tipo == 'editar'
                        ? formatoGeneral.numero_columnas_dano_severo.toString()
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (formFormatoGeneral.isValidForm()) {
                        ...
                        formatosGeneralesProvider.cargarFormatosGenerales(levantamiento.id!);
