    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, 'levantamientos');
          },
        ),
        elevation: 0,
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.pushReplacementNamed(
                              context, 'formato_general', arguments: {
                        ...
                        child: const CardFormatos(
                            nombre: 'Formato General', imagen: Icons.note)),
                    const CardFormatos(
                        nombre: 'Formato Escuela',
                        imagen: Icons.add_business_rounded),
                    const CardFormatos(
                        nombre: 'Formato Hospital',
